...
/**
 * The standard interface for executable commands. This interface is easiest to use if the executable takes mainly strings as parameters.
 * @author aliu
 *
 */
public interface Command {
	...
	/**
	 * The default method that all command objects implement. This is what the object will execute in most cases.
