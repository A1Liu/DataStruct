...
/**
 * This interface represents the format of a command object for the commandList. By default, its execute method calls a method with no parameters.
 * 
 * 
 * 
 * @author Alyer
 *
 */
public abstract class PCommand implements Command {
	 ...
	 */
	protected PCommand(String...reqs) {
		PARAM_REQS = reqs;
	}
