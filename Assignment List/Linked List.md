...
*HINTS:  *
    ...
    Consider adding at the beginning of the list, at the end of the list, and elsewhere in the list.  Consider deleting at the beginning of the list, at the end of the list, and elsewhere in the list.  Get all additions to work before working on deletions.
    Make sure you can add or delete at least three numbers that follow each other.
    Consider that the list may be empty.
...
(Remember that all quizzes must also be completed)
